...
export default function OrganizationChart({
 ...
 const router = useRouter();
  ...
  const generateMermaidDefinition = (data: OrganizationChartProps["data"]) => {
    ...
    data.organizations.forEach((org) => {
      ...
      const imageHtml = org.imageUrl
        ...
        : `<img src='${DEFAULT_ORG_IMAGE_URL}' ${profilePicStyle} />`;
        ...
        teamCircles.forEach((circle) => {
          ...
          circlePeople.forEach((person) => {
            ...
            const imageHtml = person.imageUrl
              ...
              : `<img src='${DEFAULT_PEOPLE_IMAGE_URL}' ${profilePicStyle} />`;
  ...
  const generateClassDefinitions = () => {
    return `
      classDef organization fill:#FEF2F2,stroke:#DC2626,stroke-width:3px,color:#1F2937,rx:12,ry:12,font-weight:600
      classDef team fill:#F9FAFB,stroke:#374151,stroke-width:2px,color:#1F2937,rx:10,ry:10,font-weight:500
      classDef circle fill:#F3F4F6,stroke:#6B7280,stroke-width:2px,color:#374151,rx:10,ry:10,font-weight:500
      classDef person fill:#FFFFFF,stroke:#9CA3AF,stroke-width:2px,color:#4B5563,rx:8,ry:8,font-weight:400
    `;
  };
